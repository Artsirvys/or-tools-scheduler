...
export default function ParticipantSchedulePage({ params }: SchedulePageProps) {
  ...
  const generateAvailableMonths = () => {
    ...
    // Add next month
    months.push({
      value: format(addMonths(currentDate, 1), 'yyyy-MM'),
      label: format(addMonths(currentDate, 1), 'MMMM yyyy')
    })
  ...
  const handleExport = () => {
    alert("Schedule exported to PDF! Please check your Downloads folder.")
  }
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900 dark:text-white">My Team Schedule</span>
              </div>
            </div>
          </div>
        </header>
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">Loading schedule data...</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {teamInfo ? (
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Your team schedule for {teamMembers.length} members
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Team Schedule</h1>
              <p className="text-gray-600 dark:text-gray-300">
          ...
          <>
            ...
            <Card className="mb-8">
              <CardHeader>
                ...
                <CardDescription>
                  This schedule was generated considering everyone&apos;s availability and preferences
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <ul className="mt-1 text-gray-600 dark:text-gray-300">
                      ...
                      <li>• Based on your availability</li>
                      <li>• Optimized for team coverage</li>
                    </ul>
                  </div>
                  <div>
              ...
              <CardContent>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse text-sm">
                    ...
                    <thead>
                      <tr>
                        <th className="border p-3 bg-gray-50 dark:bg-gray-800 text-left font-medium">Date</th>
                                    ...
                                    {assignedMember ? (
                                      ...
                                      >
                                        <div className="font-medium text-sm flex items-center">
                                          ...
                                          {isMyShift && (
                                            <Badge className="ml-2 text-xs bg-yellow-100 text-yellow-800">You</Badge>
                                          )}
                                        </div>
                                      </div>
                                    ) : (
                ...
                <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <h4 className="font-medium mb-2">Schedule Legend:</h4>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                You don&apos;t have access to this team&apos;s schedule
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  The team you&apos;re looking for doesn&apos;t exist or you don&apos;t have permission to view its schedule.
                </p>
                <Link href="/participant/dashboard">
