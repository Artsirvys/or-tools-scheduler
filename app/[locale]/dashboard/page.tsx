...
import { Calendar, Users, Brain, Plus, FileDown, Bell, LogOut, Check, Star, X, Clock, Heart, Trash2, Mail, Settings2, CalendarDays, Sparkles } from "lucide-react"
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="w-full sm:w-auto sm:flex sm:items-center sm:gap-4">
              <div className="grid grid-cols-2 gap-2 sm:flex sm:items-center sm:gap-4">
                <Button 
                  variant="ghost" 
                  size="sm"
                  onClick={() => setShowFeedbackDialog(true)}
                  className="w-full justify-center text-sm sm:w-auto sm:text-base font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-1.5"
                >
                ...
                <Button 
                  ...
                  className="w-full justify-center text-sm sm:w-auto sm:text-base font-medium text-pink-600 hover:text-pink-700 hover:bg-pink-50 dark:hover:bg-pink-900/20 flex items-center gap-1.5"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Your teams</h2>
                  <p className="mt-1 max-w-xl text-sm text-muted-foreground">
                    Open <span className="font-medium text-foreground/90">Schedule</span> to choose a month and run{" "}
                    <span className="font-medium text-foreground/90">Generate schedule</span> when your team’s availability
                    is ready—no need to generate from this list.
                  </p>
                </div>
              ...
              <div className="space-y-5">
                {teams.map((team) => (
                  <Card
                    key={team.id}
                    className="group relative overflow-hidden border border-border/80 shadow-sm transition-all duration-200 hover:border-blue-200/70 hover:shadow-md dark:hover:border-blue-900/50"
                  >
                    <div
                      className="h-1 w-full bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-500"
                      aria-hidden
                    />
                      ...
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div className="min-w-0 flex-1 space-y-1">
                          ...
                          <CardDescription className="text-sm">
                            Created {new Date(team.created_at).toLocaleDateString(undefined, { dateStyle: "medium" })}
                          </CardDescription>
                        </div>
                        <Button
                          variant="ghost"
                    ...
                    <CardContent className="space-y-4 pb-6 pt-0">
                      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                        <Link href={`/teams/${team.id}/manage`} className="min-w-0">
                          <Button
                            variant="outline"
                            className="h-auto w-full justify-start gap-3 border-border/80 py-3 pl-4 pr-3 text-left shadow-none transition-colors hover:border-blue-200/80 hover:bg-blue-50/50 dark:hover:border-blue-900/40 dark:hover:bg-blue-950/20"
                          >
                            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-muted/80 text-foreground">
                              <Settings2 className="h-5 w-5" aria-hidden />
                            </span>
                            <span className="min-w-0">
                              <span className="block font-semibold leading-tight">Manage</span>
                        ...
                        <Button
                          variant="outline"
                          className="h-auto w-full justify-start gap-3 border-border/80 py-3 pl-4 pr-3 text-left shadow-none transition-colors hover:border-indigo-200/80 hover:bg-indigo-50/50 dark:hover:border-indigo-900/40 dark:hover:bg-indigo-950/20"
                          onClick={() => {
                            window.location.href = `/schedule/host/${team.id}`
                          }}
                        >
                          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-indigo-500/10 text-indigo-700 dark:text-indigo-300">
                          ...
                          <span className="min-w-0">
                            ...
                            <span className="mt-0.5 block text-xs font-normal text-muted-foreground">
                              Calendar, generate AI schedule, export
                            </span>
                          </span>
                        </Button>
                        ...
                        <Button
                          variant="outline"
                          className="h-auto w-full justify-start gap-3 border-border/80 py-3 pl-4 pr-3 text-left shadow-none transition-colors hover:border-emerald-200/80 hover:bg-emerald-50/50 dark:hover:border-emerald-900/40 dark:hover:bg-emerald-950/20"
                          onClick={() => {
                            window.location.href = `/teams/${team.id}/availability`
                          }}
                        >
                          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-emerald-500/10 text-emerald-800 dark:text-emerald-300">
                            <Users className="h-5 w-5" aria-hidden />
                          </span>
                          <span className="min-w-0">
                            <span className="block font-semibold leading-tight">View team&apos;s availability</span>
                            <span className="mt-0.5 block text-xs font-normal text-muted-foreground">
                              Who marked available and when
                            </span>
                          </span>
                        </Button>
                      </div>
